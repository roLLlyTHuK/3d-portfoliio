    ...
    const handleSubmit = (e) => {
        ...
        emailjs.send(
            ...
            import.meta.env.VITE_APP_EMAILJS_TEMPLATE_ID,
            {
                ...
                to_email: `dovhaniuk.andriy@gmail.com`,
                message: form.message,
            },
            import.meta.env.VITE_APP_EMAILJS_PUBLIC_KEY,
        ).then(() => {
            setIsLoading(false);
            showAlert("Thank you. I will get back to you as soon as possible.", "success");
            setTimeout(() => {
                hideAlert();
            ...
            setIsLoading(false);
            setCurrentAnimations('idle');
            showAlert('I did not receive your message. Please try again', "danger");
